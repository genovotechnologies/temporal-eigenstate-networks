...
\toprule
Model & $T\!=\!512$ & $T\!=\!2048$ & $T\!=\!8192$ & $T\!=\!16384$ & $T\!=\!32768$ & $T\!=\!65536$ \\
\midrule
TEN-FFT & \textbf{23} & \textbf{80} & \textbf{310} & \textbf{312} & \textbf{315} & \textbf{320} \\
Naive attention & 26 & 147 & OOM & OOM & OOM & OOM \\
Transformer (SDPA) & 23 & 92 & 473 & 631 & 958 & 1669 \\
\midrule
Speedup (vs naive) & 1.1$\times$ & 1.8$\times$ & --- & --- & --- & --- \\
Speedup (vs SDPA) & 1.0$\times$ & 1.2$\times$ & 1.5$\times$ & 2.0$\times$ & 3.0$\times$ & \textbf{5.2}$\times$ \\
\bottomrule
\end{tabular}
\end{table}
